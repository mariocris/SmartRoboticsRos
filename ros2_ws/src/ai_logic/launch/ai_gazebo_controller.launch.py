...
def generate_launch_description():
	...
	xacro_file = get_package_share_directory('ai_logic') + '/description'+'/xacro/'+ robot_model +'.urdf.xacro'
	...
	world_file_name = 'gazeboWorld.world'
	#world_file_name = 'rl_world_box.world'
	world = os.path.join(get_package_share_directory('ai_logic'), 'worlds', world_file_name)
